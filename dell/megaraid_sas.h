 ...
 */
#define MEGASAS_VERSION				"07.700.52.00"
#define MEGASAS_RELDATE				"Sep 19, 2017"
#define MEGASAS_EXT_VERSION			"Sep 19 07, 17:00:00 PDT 2017"
#define FALSE 0
#define TRUE 1

/*
 * Macros to create appropriate pci-id from a device-id
 */
#define MR_PCI_ID(pdev)	\
	(((u32)((pdev)->vendor) << 16) | (pdev)->device)
#define MR_PCI_ID_LSI(device) \
	(((u32)(PCI_VENDOR_ID_LSI_LOGIC) << 16) | (device))
#define MR_PCI_ID_DELL(device) \
	(((u32)(PCI_VENDOR_ID_DELL) << 16) | (device))
...
struct megasas_instance {
	...
	/* preferred count to send as LDIO irrspective of FP capable.*/
