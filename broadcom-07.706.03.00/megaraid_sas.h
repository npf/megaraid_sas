 ...
 */
#define MEGASAS_VERSION				"07.706.03.00"
#define MEGASAS_RELDATE				"Mar 01, 2018"
#define MEGASAS_EXT_VERSION			"Mar 01, 17:00:00 PDT 2018"
...
struct MR_TARGET_PROPERTIES {
    ...
    u32    device_qdepth;
    u32    sector_size;
    u8     reset_tmo; // Target Reset timeout
    u8     reserved[499];
} __packed;
...
struct megasas_instance {
	...
	u8 task_abort_tmo;
	u8 max_reset_tmo;
	bool divert_io_with_chain_frame;
};
